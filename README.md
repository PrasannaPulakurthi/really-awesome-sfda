...
- Unraveling the Mysteries of Label Noise in Source-Free Domain Adaptation: Theory and Practice [`paper`](https://www.computer.org/csdl/journal/tp/2025/05/10858421/23VPxGAlL4Q) [`code`](https://github.com/xugezheng/labelNoiseInSFDA) `TPAMI'25` [![Stars](https://img.shields.io/github/stars/xugezheng/labelNoiseInSFDA?style=social)](https://github.com/xugezheng/labelNoiseInSFDA)
...
- Neighborhood-Aware Mutual Information Maximization for SFDA [`paper`](https://ieeexplore.ieee.org/document/10510655) `TMM'24`
